...
PDF 以 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) 协议发布, 可在 [Releases](https://github.com/userElaina/Open-JLU/releases) 下载.

**注意: 下列项目中存在 *[Gitee](https://gitee.com/)* 的项目, 以*斜体*标注, 有一定安全需求的用户请注意甄别.**
...
| 图书馆座位预约脚本 | [JLU LibSeat PC Wide](https://github.com/flash122u/jlu-libseat-pc-wide) | PC 端座位图增强和预约辅助 |
---
...
| Others | 计院速通课程资料 | [JLUCS_Speedrun](https://github.com/Xiaoc7r/JLUCS_Speedrun)|  |
...
| _计算思维_ | _课前展示(实验)_ | [_convnext_2024ci_](https://gitee.com/c1rno/convnext_2024ci) | _基于convnext的图像分类, 含PPT_ |
...
| 软件系统综合开发实践 | B/S 端 | [学生宿舍管理系统](https://github.com/ExTNT/student_dormitory) | PostgreSQL+ Go + Vue实现 |
